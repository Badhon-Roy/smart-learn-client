                               ...
                               <Typography variant="h6" className="mb-2">Our Mission</Typography>
                                <div>
                                    ...
                                    <div className="my-4 space-y-4">
                                        <h2>
                                            <span className="text-[#07a698] rounded-full border bg-white shadow-lg md:p-2 p-1 font-bold md:text-lg text-sm mr-2">01</span>
                                            Deliver Industry-Relevant Content Taught by Experts
                                        </h2>
                                        <h2>
                                            <span className="text-[#07a698] rounded-full border bg-white shadow-lg md:p-2 p-1 font-bold md:text-lg text-sm mr-2">02</span>
                                            Foster Continuous Learning and Career Advancement
                                        </h2>
                                        <h2>
                                            <span className="text-[#07a698] rounded-full border bg-white shadow-lg md:p-2 p-1 font-bold md:text-lg text-sm mr-2">03</span>

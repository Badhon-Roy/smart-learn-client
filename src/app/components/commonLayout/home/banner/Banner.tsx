...
const Banner = () => {
    ...
    return (
        <div className="bg-[#1f2b2a] lg:min-h-[70vh] md:min-h-[60vh] min-h-[50vh] flex flex-col justify-center items-center relative">
            ...
            <div className="absolute right-0 -bottom-10 z-10 md:h-[450px] h-[250px] w-[240px] md:w-[430px] rotate-45 bg-gradient-to-l from-[#07e0cb] to-cyan-400 opacity-30 blur-[150px] filter dark:opacity-50 md:block hidden"></div>

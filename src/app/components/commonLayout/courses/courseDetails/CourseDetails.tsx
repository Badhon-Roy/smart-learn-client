...
const CourseDetails = ({ course, filterCourse }: { course: ICourse, filterCourse: ICourse[] }) => {
    ...
    return (
        <div>
            <div className="bg-[#0e1523] min-h-[250px] ">
                <div className="container mx-auto py-8 px-4 text-white">
                    <div className="lg:max-w-2/3">
                        ...
                        <h2 className="lg:text-[40px] md:text-[30px] text-[20px] mt-4">{title}</h2>
            ...
            <div className="container mx-auto py-8 px-4 flex flex-col-reverse lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-2/3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-4 mt-4">
                        {uniqueInstructors?.map((item, idx) => (
                            <div key={idx} className="flex items-center gap-4 border border-gray-300 px-4 py-2 rounded-lg">
                                <Image
                                    className="md:w-[90px] w-[40px] md:h-[90px] h-[40px] border border-[#07a698] object-cover rounded-full mb-2"
                                ...
                                />
                                <div>
                                    <h3 className="md:text-lg font-semibold">{item.instructor?.name}</h3>
                    ...
                    <div className="grid  md:grid-cols-2 gap-6">
                        <div className="flex items-center gap-4 mt-8 bg-[#fff0f8] p-8 rounded-2xl">
                            <div className="w-2/3">
                                <span className="bg-[#a66bfe] md:px-6 md:py-3 px-3 py-1 text-sm md:text-[16px] rounded-full text-white">মেন্টরশিপ</span>
                        ...
                        <div className="flex items-center gap-4 mt-8 bg-[#fff0f8] p-8 rounded-2xl">
                            <div className="w-2/3">
                                <span className="bg-[#ea872c] md:px-6 md:py-3 px-3 py-1 text-sm md:text-[16px] rounded-full text-white">সাপোর্ট সিস্টেম</span>
                        ...
                        <div className="flex items-center gap-4 mt-8 bg-[#f0faff] p-8 rounded-2xl">
                            <div className="w-2/3">
                                <span className="bg-[#1da1f2] md:px-6 md:py-3 px-3 py-1 text-sm md:text-[16px] rounded-full text-white">লাইফটাইম এক্সেস</span>
                        ...
                        <div className="flex items-center gap-4 mt-8 bg-[#e8fff5] p-8 rounded-2xl">
                            <div className="w-2/3">
                                <span className="bg-[#16a34a] md:px-6 md:py-3 px-3 py-1 text-sm md:text-[16px] rounded-full text-white">প্রজেক্ট ভিত্তিক শেখা</span>
                        ...
                        <div className="flex items-center gap-4 mt-8 bg-[#f5eaff] p-8 rounded-2xl">
                            <div className="w-2/3">
                                <span className="bg-[#8b5cf6] md:px-6 md:py-3 px-3 py-1 text-sm md:text-[16px] rounded-full text-white">সার্টিফিকেট</span>
                ...
                <div className="w-full lg:w-1/3 md:w-2/3 lg:sticky top-32 bg-white p-6 rounded-lg shadow-md h-full border border-gray-300">
